<script lang="ts">
	import { Accordion as AccordionPrimitive } from "$lib/vendor/bits-ui/dist/index.js";
	import ChevronDownIcon from "$lib/vendor/lucide/icons/chevron-down.svelte";
	import ChevronUpIcon from "$lib/vendor/lucide/icons/chevron-up.svelte";
